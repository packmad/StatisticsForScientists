...
\paragraph{Example: a reaction-time experiment.}
...
\paragraph{Example: an ordinal usability rating study.}
...
\paragraph{Example: study time and exam performance.}
...
\paragraph{Example: confidence intervals for a hard-to-analyze statistic.}
